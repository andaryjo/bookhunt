...
> Disclaimer: This application has almost entirely written by an AI.
...
- LLMs are really good to quickly create working prototypes so you prove a market fit early on.
...
- I am concerned about continuing to maintain this on my own.
  I do have a pretty good understanding of the system architecture since I didcated it, but I don't know the code and would probably struggle to change stuff on my own now.
